...
from parase import *
""" 
python attack_cifar.py  --bs 64  --eps 0.3 --alpha 0.12 --iters 40 --atkmod fgsm
"""
...
def main(args):
    ...
    if args.atkckpts:
        ...
        atkckpts = "ckpts/atlgp_cifar.ckpt"

    param_dict = ms.load_checkpoint(atkckpts)
    # param_dict = ms.load_checkpoint("ckpts/atlgp_minist.ckpt")
    ...
    # advs = batch_generate(test_images, true_labels, batch_size=32, eps=0.3,mod='fgsm')
#     before
