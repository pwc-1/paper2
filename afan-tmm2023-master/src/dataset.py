...
class VideoDataset():
    ...
    def __getitem__(self, index):
        ...
        if self.subset == "train":
            match_score_start, match_score_end, confidence_score, num_action = self._get_train_label(index, self.anchor_xmin,
                                                                                         self.anchor_xmax)
            return video_data, confidence_score, match_score_start, match_score_end, num_action
        return (video_data,)
    ...
    def _get_train_label(self, index, anchor_xmin, anchor_xmax):
        ...
        return match_score_start, match_score_end, gt_iou_map, num_action
