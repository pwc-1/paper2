...
from src.an_classifier import AN_classifier, AN_classifier_WithLossCell
from src.loss import AN_classifier_Loss #, get_mask
...
if __name__ == '__main__':
    ...
    #loss
    loss = AN_classifier_Loss(mode="train")

    # train net
    train_net = AN_classifier_WithLossCell(network, loss)
    ...
    ckpoint_cb = ModelCheckpoint(prefix="AN_classifier_auto_",
    ...
    logger.info("Exp. %s - AN_classifier_Loss train success", (cfg.experiment_name))
